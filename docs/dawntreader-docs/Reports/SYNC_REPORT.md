...
The working tree had uncommitted changes (from earlier, unrelated StarVizion Keyboard/Counter Vizlet work) to `../../../app/src/main/resources/i18n/gui.properties`, which would have collided with
