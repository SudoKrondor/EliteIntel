...
`SAVED_TEXT` минует недавнюю, сохранённую и ожидающую области, общий автоматический предел в 200 символов и сжатие. Для него действуют собственные пределы: до 1000 символов в записи и до 500 записей за сеанс. Допустимая фраза хранится дословно; точный дубликат повторно не добавляется, а превышение предела отклоняется до изменения памяти.
