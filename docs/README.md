...
- [Bind Editor](02-features/bindforge/bind-editor.md) — Game Mode, Anomalies and shared conflict
  detection in V1.2; Action Groups, Input Mode, Control Types and Controller Mode [deferred](00-overview/v1.2-scope.md#the-v12-release-is-trimmed--settled-2026-09-16)
