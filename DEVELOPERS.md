...
- **Current backends**:
  ...
  - `elite.intel.ai.mouth.supertonic.SupertonicTTS` - **alternative,
    offline**. Same pipeline over the Supertonic 3 model (one multilingual model, language passed per call, ten voices). It is the local engine a Russian or Ukrainian commander gets, and a choice for everyone else (`TtsProvider.SUPERTONIC`).
  -
