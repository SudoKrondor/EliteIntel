 ...
 * <p>
 * COMMANDER uses one worker so prompt/classification/topic and dialogue/query memory commits remain ordered; game
 * handlers detach after that stage. EVENT also uses one worker. The generic concurrency argument remains for lanes whose
