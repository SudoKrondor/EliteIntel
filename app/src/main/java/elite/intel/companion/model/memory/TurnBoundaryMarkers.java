 ...
 * <ul>
 *   <li>{@link #NO_ANSWER} / {@link #INTERRUPTED} - the companion's own (assistant-side) boundary, recorded as a
 *       {@code COMPANION} short-term entry when a turn drew no reply or was cut off; they replay as plain
 *       {@code assistant} messages.</li>
