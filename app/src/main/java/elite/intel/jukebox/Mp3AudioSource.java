...
final class Mp3AudioSource implements AudioSource {
    ...
    /**
     * A growable byte queue of canonical PCM, filled by the resampler and drained by the player.
     */
    private static final class PcmBuffer implements PcmResampler.ByteSink {
