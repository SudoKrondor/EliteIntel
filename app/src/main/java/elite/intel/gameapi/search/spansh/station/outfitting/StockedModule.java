 ...
 *
 * @param name   the module's name as Spansh lists it, which is how a broad request ("lasers") tells the
 *               commander which of the family is on the shelf
 ...
 */
public record StockedModule(String name, int size, String rating, String mount, long price) {
