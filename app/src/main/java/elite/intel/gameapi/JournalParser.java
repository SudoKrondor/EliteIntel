        ...
        try (WatchService watchService = FileSystems.getDefault().newWatchService()) {
            ...
            while (isRunning && currentFile == null) {
                try {
                    ...
                    if (!journalWarningSpoken) {
                        ...
                        GameEventBus.publish(new AiVoxResponseEvent("Commander, no game session detected. Standing by."));
            ...
            while (isRunning) {
                ...
                try (SeekableByteChannel channel = Files.newByteChannel(currentFile, StandardOpenOption.READ)) {
                    ...
                    GameEventBus.publish(new AiVoxResponseEvent("Error reading journal: " + e.getMessage()));
