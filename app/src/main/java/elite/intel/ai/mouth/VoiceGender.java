...
/**
 * The gender VEGA is heard as, derived from the voice the active ship carries.
 * <p>
 * The voice is the only thing a commander picks, and it decides two separate things: which speaker the TTS
 * engine synthesises, and how VEGA refers to herself or himself in speech. Those used to be
