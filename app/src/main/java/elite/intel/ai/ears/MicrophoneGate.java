...
/**
 * What stands between the microphone and VEGA, decided once per finished utterance.
 * <p>
 ...
 * sleeping VEGA still listens for. A listen-prefixed order ("listen, open the galaxy map") gets through
