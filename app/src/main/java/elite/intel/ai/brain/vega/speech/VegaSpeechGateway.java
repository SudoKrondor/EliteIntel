 ...
 */
public final class VegaSpeechGateway implements SpeechGateway {

    /**
     * Origin marker on the vocalisation event; VEGA voice is an AI response to the commander.
     */
     ...
     */
    VegaSpeechGateway(Consumer<Object> publisher) {
