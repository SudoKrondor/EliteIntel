...
/**
 * Stage-4b self-describing command for "show contacts panel".
 * Owns its own execution (ownsExecution() == true): the dispatch map routes this
 * command's execute() in place of the legacy OpenContactsHandler.
 */
@RegisterCommand
public final class ShowContactsPanelCommand implements IntelCommand {
    ...
    @Override
    public String id() {
        return CommandIds.SHOW_CONTACTS_PANEL;
    }
