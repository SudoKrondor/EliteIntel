...
/**
 * Stage-4b self-describing command for "show transactions panel".
 * Owns its own execution (ownsExecution() == true): the dispatch map routes this
 * command's execute() in place of the legacy OpenTransactionHandler.
 */
@RegisterCommand
public final class ShowTransactionsPanelCommand implements IntelCommand {
    ...
    @Override
    public String id() {
        return CommandIds.SHOW_TRANSACTIONS_PANEL;
    }
