...
@RegisterQuery(before = {
        AnalyzeSquadronCarrierRouteQuery.ID,
        AnalyzeSquadronCarrierFinalDestinationQuery.ID,
        AnalyzeSquadronCarrierETAQuery.ID
})
public class AnalyzeSquadronCarrierDataQuery extends BaseQueryAnalyzer implements IntelQuery {
    public static final String ID = "query_squadron_carrier_status_fuel_credit_finance";

    @Override
    public String llmDescription() {
        return "Report the SQUADRON carrier's status: tritium fuel, jump range, balance and finances. Not the commander's personal fleet carrier.";
    }
