 ...
 */
public final class VegaSystemPrompt implements SystemPromptText {
    ...
    static String vegaName() {
        return VegaConfig.vegaName();
    }

    /**
     * Who VEGA is - the same clause the analysis prompt opens with.
     */
    static String identityClause() {
        return VegaIdentity.identityClause();
    }
    ...
    /**
     * How VEGA speaks of itself: the grammatical gender of the voice the active ship carries.
     * <p>
