...
/**
 * The shape of a completed VEGA-memory record. Each kind has one fixed shape; the model does not classify it.
 * <p>
...
public enum MemoryKind {
    /**
     * A completed commander/VEGA conversational exchange.
     */
    DIALOGUE,
