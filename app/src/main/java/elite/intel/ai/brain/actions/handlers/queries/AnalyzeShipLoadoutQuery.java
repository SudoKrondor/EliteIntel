...
public class AnalyzeShipLoadoutQuery extends BaseQueryAnalyzer implements IntelQuery {
    ...
    public String llmDescription() {
        return "Report the current ship's installed modules, weapons and equipment, or whether a specific module (refinery, fuel scoop, shield generator, etc.) is on board.";
    }
