...
/**
 * One complete VEGA runtime generation. All references visible through {@link VegaRuntime} belong to
 ...
 */
public final class VegaRuntimeGraph implements AutoCloseable {
    ...
    private final VegaActionReducer actionReducer;
    private final VegaState vegaState;
    private final VegaNarrator narrator;
    ...
    VegaRuntimeGraph(
        ...
        this(runtimeGeneration, llmGateway, speechGateway, executionGateway, memoryGateway, actionReducer,
                vegaState, narrator, thoughtDispatcher, confirmationCoordinator, bargeInController,
                memoryGateway, oversizedMemoryCompressor, speechGateway, false);
    ...
    VegaRuntimeGraph(
        ...
        this(runtimeGeneration, llmGateway, speechGateway, executionGateway, memoryGateway, actionReducer,
                vegaState, narrator, null, null, null, null, null,
    ...
    private VegaRuntimeGraph(
        ...
        this.vegaState = Objects.requireNonNull(vegaState, "vegaState");
    ...
    public synchronized void start() {
        if (closed.get()) {
            throw new IllegalStateException("Cannot start a closed VEGA runtime graph");
        }
        if (started.get()) {
            return;
        }
    ...
    public VegaRuntimeGeneration runtimeGeneration() {
    ...
    public VegaActionReducer actionReducer() {
        return actionReducer;
    }

    public VegaState vegaState() {
        return vegaState;
    }

    public VegaNarrator narrator() {
        return narrator;
    }
    ...
    private static void closeIfPresent(AutoCloseable resource) {
        ...
        try {
            ...
            throw new IllegalStateException("VEGA resource cleanup failed", impossibleCheckedFailure);
        }
    }
