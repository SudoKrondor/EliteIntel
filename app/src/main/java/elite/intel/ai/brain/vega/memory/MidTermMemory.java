...
public final class MidTermMemory {
    ...
    public List<MemoryRecord> records(MemoryKind kind) {
    ...
    public Map<MemoryKind, List<MemoryRecord>> retainedSnapshot() {
        return snapshot(retainedByKind);
    }

    /** Returns records that remain searchable until their summary is committed. */
    public Map<MemoryKind, List<MemoryRecord>> pendingSnapshot() {
    ...
    public List<MemoryRecord> stageOverflow() {
