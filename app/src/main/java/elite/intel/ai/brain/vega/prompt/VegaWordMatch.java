...
/**
 * Decides whether two single words are "the same word" for VEGA's command word-overlap, tolerant of
 ...
 * Deliberately a VEGA-local helper (not the DB-backed {@code FuzzySearch}): it compares two plain words,
 * with no database, no candidate list, and a length-scaled budget tuned for short command words.
 * <p>
 * Shared owner of word-level similarity for VEGA: besides command word-overlap
 ...
 */
public final class VegaWordMatch {

    private VegaWordMatch() {
    }
