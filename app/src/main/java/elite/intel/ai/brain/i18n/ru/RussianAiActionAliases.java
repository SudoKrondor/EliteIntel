...
public class RussianAiActionAliases implements AiActionAliasProvider {
    ...
    public void addAliases(Map<String, String> map, Status status, boolean isDryRun) {
        ...
        if (status.isInMainShip() || isDryRun) {
            ...
            map.put("прыжок в гиперпространство, прыгай, гиперпрыжок, войти в гиперпространство, следующий маршрутный пункт, прыжок к следующей точке маршрута", JUMP_TO_HYPERSPACE.getAction());
            ...
            map.put("автопилот, такси, такси на посадку, такси к посадке, такси, автопосадка, автоматическая посадка, автопилот, автоматическая стыковка", TAXI.getAction());
            ...
            map.put("убери шасси, шасси вверх, подними шасси, сложи посадочное шасси, поднять шасси", RETRACT_LANDING_GEAR.getAction());
            ...
            map.put("огонь, истребитель свободный огонь, огонь по усмотрению, атаковать по усмотрению, атакуй самостоятельно, открыть огонь", FIGHTER_OPEN_ORDERS.getAction());
        ...
        if (status.isInMainShip() || status.isInSrv() || isDryRun) {
            ...
            // UI panels
            map.put("покажи панель командира, открой центральную панель, открой панель ролей, наколенный планшет", SHOW_COMMANDER_PANEL.getAction());
        ...
        map.put("проложенный маршрут, оставшиеся прыжки, топливо на следующей остановке, наличие топлива на маршруте, анализ маршрута, мы уже на месте, текущий маршрут, сколько прыжков осталось, следующая заправка", PLOTTED_ROUTE_ANALYSIS.getAction());
        ...
        map.put("экипировка, снаряжение, есть ли на борту X, компоновка корабля, отчет о повреждениях, модули корабля, готовность к бою, оборудование корабля, характеристики корабля, на чем я лечу, что установлено, генератор щитов, усиление корпуса, сенсоры, двигатели, FSD, Frame Shift Drive, топливозаборник", SHIP_LOADOUT.getAction());
        ...
        map.put("как далеко до Земли, расстояние до Пузыря, расстояние до Sol, расстояние до Сола, расстояние до Земли, как далеко от населенного космоса, как далеко от Пузыря, как далеко от цивилизации, расстояние от населенного космоса", DISTANCE_TO_BUBBLE.getAction());
