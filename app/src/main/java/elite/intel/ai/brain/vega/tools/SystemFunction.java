...
/**
 * Self-describing VEGA system function (speak or request_input), modeled on
 * {@code IntelCommand} and - like every other invokable tool -
 ...
 * function reaches the gateways/state it needs statically via {@code VegaRuntime}.
 */
