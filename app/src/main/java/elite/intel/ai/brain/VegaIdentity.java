...
/**
 * The single source of who VEGA is: its name and the identity clause that opens every prompt
 * whose output the commander hears.
 * <p>
 * It is an AI and says so. Earlier prompts pulled in two directions - VEGA prompts called it
 ...
 */
public final class VegaIdentity {

    // TODO: back VEGA name by GUI/DB settings (see VegaConfig).
    private static final String NAME = "Vega";

    private VegaIdentity() {
    }

    /**
     * VEGA's own name, as written into every prompt.
     * <p>
    ...
    public static String identityClause() {
        return "You are " + NAME + ", an artificial intelligence: VEGA AI of an independent commander "
