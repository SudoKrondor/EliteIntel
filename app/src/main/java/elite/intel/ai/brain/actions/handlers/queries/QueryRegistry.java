...
/**
 * Scans elite.intel.ai.brain.actions.handlers.queries (recursively) for @RegisterQuery
...
public final class QueryRegistry {
    ...
    private static final String SCAN_PACKAGE = "elite.intel.ai.brain.actions.handlers.queries";
