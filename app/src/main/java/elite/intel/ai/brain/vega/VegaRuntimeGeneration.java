...
/**
 * Identity and liveness token for one installed VEGA runtime. Asynchronous work keeps this token so a
 ...
 */
public final class VegaRuntimeGeneration {
    ...
    /**
     * Creates the next active process-local VEGA generation.
     */
    public VegaRuntimeGeneration() {
    }
