...
public final class FindEncodedMaterialTraderCommand implements IntelCommand {
    ...
    public JsonObject execute(JsonObject params, String responseText) {
        ...
        JsonObject plotOutcome = routePlotter.plotRoute(search.location(TraderType.ENCODED, null, range));
        if (plotOutcome != null) {
            return plotOutcome;
        }
        return CommandOutcome.critical(StringUtls.localizedLlm("handler.trader.searching", TraderType.ENCODED.getType()));
    }
}
