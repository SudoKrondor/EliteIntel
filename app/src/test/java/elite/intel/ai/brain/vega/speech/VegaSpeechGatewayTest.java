 ...
 */
class VegaSpeechGatewayTest {

    private final List<Object> published = new ArrayList<>();
    private final VegaSpeechGateway gateway = new VegaSpeechGateway(event -> {
        published.add(event);
    ...
    void noActiveMouthFailsImmediately() {
        VegaSpeechGateway unclaimed = new VegaSpeechGateway(published::add);
