 ...
 */
class VegaSpeechGatewayBusIntegrationTest {
    ...
    private static final class NestedSpeechSubmitter {
        private final VegaSpeechGateway gateway;
        private volatile CompletableFuture<Void> completion;

        private NestedSpeechSubmitter(VegaSpeechGateway gateway) {
    ...
    private final VegaSpeechGateway gateway = new VegaSpeechGateway();
    ...
    void utteranceReachesMouthWithCallerFuture() {
        ...
        assertTrue(mouth.received.canBeInterrupted(), "VEGA speech must be interruptible");
