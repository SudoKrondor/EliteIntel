...
class VegaMemoryDumpTest {
    ...
    void dumpContainsTheReplayedWindowAndItsCounts() {
        JsonObject dump = JsonParser.parseString(VegaMemoryDump.toJson(sampleSnapshot())).getAsJsonObject();
    ...
    void recordKeepsKindTimestampAndEntries() {
        JsonObject record = JsonParser.parseString(VegaMemoryDump.toJson(sampleSnapshot()))
