...
/**
 * Measurement (report) for {@link VegaWordMatch} across every language the app supports. Each language
 ...
 */
class VegaWordMatchLanguagesTest {
    ...
    private double report(String language, List<Probe> probes) {
        ...
        for (Probe probe : probes) {
            boolean got = VegaWordMatch.similar(probe.a(), probe.b());
            if (got == probe.same()) {
                correct++;
            } else {
