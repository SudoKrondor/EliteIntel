...
> ### ⚠️ Потрібна мовна модель (LLM)
> Elite Intel — це голос і руки, а LLM — мозок. Без неї застосунок не працює.
> Запустіть модель локально на своїй відеокарті або скористайтеся **безкоштовним** хмарним рівнем на
> 👉 **[console.mistral.ai](https://console.mistral.ai/)** 👈 — кредитна картка не потрібна.
> Див. [Безкоштовний хмарний LLM](cloud-llm-options) або [Обрати LLM](installing-local-llms).
...
**Безкоштовно й офлайн**  [LM Studio](https://lmstudio.ai/) із локальною моделлю  
**Безкоштовна хмара**  [Mistral](https://console.mistral.ai/)  безкоштовний рівень, без кредитної картки  
